...
timemax = 2.1   # Set maximum time for integration. The one here is the one I fitted.
timestep = 0.00001   # Set timestep of any integrators. 0.00001 seems to be a *very* good spot. 0.000001 isn't doable. I used 0.00001 as recommended.
basestep = timestep   # Placeholder to reset the timestep.
whichatompointstart = 20   # Defined by the conditions data file. See "morseconditions.dat" for example, or particle3d.
...
# Form of list: [timestep_for_integration, relative_frequency_error, relative_energy_error]
