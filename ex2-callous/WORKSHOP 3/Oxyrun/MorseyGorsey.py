...
timemax = 2.65   # Set maximum time for integration. The one here is the one I fitted.
...
whichatompointstart = 13   # Defined by the conditions data file. See "morseconditions.dat" for example, or particle3d.
which_quantity = 3 # 0->3. Separation, Potential, Total KE, Total E.
