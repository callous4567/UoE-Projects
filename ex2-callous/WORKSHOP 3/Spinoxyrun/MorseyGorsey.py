...
timemax = 2.9  # Set maximum time for integration. The one here is the one I fitted.
...
whichatompointstart = 28   # Defined by the conditions data file. See "morseconditions.dat" for example, or particle3d.
