...
with open(windows_directories.clusterdir + "\\" + "finetune_fullgroup.cluster.txt", 'rb') as f:
...
for saveid in saveids:
    ...
    with open(windows_directories.duplimontedir + "\\" + ascii_info.fullgroup +
              "\\" + saveid + "_finetune.cluster.txt", 'rb') as f:
    ...
    # Save the remap
    with open(windows_directories.duplimontedir + "\\" + ascii_info.fullgroup +
              "\\" + saveid + "_finetune.remap-cluster.txt", 'wb') as f:
