...
if do_lbplots == True:
    savedir = os.path.join(windows_directories_new.imgdir, "lb_plots")
    try:
        os.mkdir(savedir)
    except:
        pass
...
if do_energyplots == True:
    ...
    savedir = os.path.join(windows_directories_new.imgdir, "energy_plots")
    try:
        os.mkdir(savedir)
    except:
        pass
...
if do_clustplots == True:
    ...
    savedir = os.path.join(windows_directories_new.imgdir, "clustplots")
    try:
        os.mkdir(savedir)
    except:
        pass
