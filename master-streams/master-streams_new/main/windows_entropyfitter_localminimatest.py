...
from energistics_new_constants import M_nfw, M_d, a_b, a_d, M_b, a_nfw, b_d, c_nfw
...
if __name__ == "__main__":
    ...
    axs.set(xlabel=r'$\frac{M_H}{M_\odot}$',
            ylabel=r'$c_H$',
            xlim=ranges[1]*energistics_new_constants.M_nfw,
            ylim=ranges[2]*energistics_new_constants.c_nfw)
    plt.savefig(windows_directories_new.imgdir + "\\entropyorphan_massmap.png", dpi=300)
    plt.show(dpi=72)
