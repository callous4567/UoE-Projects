...
class orbifitter():
    ...
    def flatfork_galpy_final_fitting(self,
        ...
        if load_fit == False:
            ...
            if try_save == True:
                with open(
                        windows_directories.datadir + "\\" + "clustered" + "\\" + str(clust_to_fit) + "_flatfork_memberpercent_galpy.orbit_fit.txt",
                        'wb') as f:
                    pickle.dump(obj=fit, file=f)
        else:
            ...
            try:
                ...
                with open(windows_directories.datadir + "\\" + "clustered" + "\\" + str(clust_to_fit) + "_flatfork_memberpercent_galpy.orbit_fit.txt",
                          'rb') as f:
                    fit = pickle.load(file=f)
            ...
            # If it doesn't exist then get the fit and then save it! If try_save is true, obviously.
                ...
                if try_save == True:
                    with open(
                            windows_directories.datadir + "\\" + "clustered" + "\\" + str(
