...
if do_lbplots == True:
    ...
    savedir = os.path.join(windows_directories.imgdir, "flatfork_lb_plots")
...
if do_energyplots == True:
    ...
    savedir = os.path.join(windows_directories.imgdir, "flatfork_energy_plots")
    try:
        os.mkdir(savedir)
    except:
        pass
...
if do_clustplots == True:
    ...
    savedir = os.path.join(windows_directories.imgdir, "flatfork_clustplots")
    try:
        os.mkdir(savedir)
    except:
        pass
