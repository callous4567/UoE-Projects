...
windows_multiprocessing_new.n_monte = 200
windows_multiprocessing_new.sourcecoord = "solar_info.dat"
results = ["null"]
# Regularly map/pool :)
if __name__ == '__main__':
    pool = multiprocessing.Pool(6)
    results = pool.map(windows_multiprocessing_new.do_covmonte_table, zipped)
    pool.close()
