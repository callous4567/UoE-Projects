...
from windows_directories_new import imgdir, datadir, duplimontedir
...
class dirbuilder(object):
    ...
    def duplimonte(self):
        ...
        # and the full one
        try:
            os.mkdir(duplimontedir + "\\" + ascii_info_new.fullgroup)
        except:
            pass
    ...
    def duplimonte_kmeanshtmldir(self):
        ...
        # and the full one
        try:
            os.mkdir(imgdir + "\\kmeans_html" + "\\duplimonte_kmeanshtml\\" + ascii_info_new.fullgroup)
        except:
            pass
    ...
    def flatfork_duplimonte_kmeanshtmldir(self):
        ...
        # and the full one
        try:
            os.mkdir(imgdir + "\\flatfork_kmeans_html" + "\\duplimonte_kmeanshtml\\" + ascii_info_new.fullgroup)
        except:
            pass
    ...
    def clustdir(self):
        try:
            os.mkdir(windows_directories_new.clusterdir)
        except:
            pass
        try:
    ...
    def orbidir(self):
        try:
            os.mkdir(windows_directories_new.orbitsdir)
        except:
            pass
        try:
            ...
            pass
        try:
            os.mkdir(windows_directories_new.orbitsfitdir)
        except:
            pass
    ...
    def orbidebugdir(self):
        try:
            os.mkdir(windows_directories_new.imgdir + "\\cluster_greatcount_debug")
        except:
            pass
    ...
    def vasidir(self):
        try:
            os.mkdir(os.path.join(windows_directories_new.imgdir, "vasiliev"))
        except:
            pass
    ...
    def flatfork_vasidir(self):
        try:
            os.mkdir(os.path.join(windows_directories_new.imgdir, "flatfork_vasiliev"))
        except:
            pass
