...
membership_monte = writer.read_table(ascii_info_new.fullgroup, "percent_table")
...
membership_table_monte_gc = writer.read_table(ascii_info_new.fullgroup, "percent_table_greatfitted")
