...
if __name__ == "__main__":
    ...
    min_clust_size = ascii_info_new.fulldata_minpar[0] # min_samples from greattable
    ...
    best_minpars = [[ascii_info_new.fulldata_minpar[0], min_samples] for min_samples in best_minpars]
    ...
    results = pool.map(windows_multiprocessing_new.do_updated_hdbscan_greatfit, arrayinfominpars)
    pool.close()
