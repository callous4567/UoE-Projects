...
for d in range(len(filedatalist)):
    if filedatalist[d] == "Sun.dat":
        ...
        solver_object = ellipse_solver(import_tool.orbit_porter(filedatalist[d]), timestep, filedatalist[d], 10000, 15000)
        ...
        solver_object = ellipse_solver(import_tool.orbit_porter(filedatalist[d]), timestep, filedatalist[d], 25, 30)
        # 1, 109500 are the step and number of steps for 300 years (Halley Closure, supposedly.)
